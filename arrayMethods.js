...
const inventorsFrom16th = inventors.filter((inventor) => { return inventor.year >= 1500 && inventor.year <1600});

console.log(inventorsFrom16th);
...
const edison = inventors.find((inventor) => {return inventor.last === "Edison"});
console.log(edison);